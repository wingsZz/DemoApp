...
import cn.outter.demo.database.entity.MessageContentConvert
...
object ChatDataBaseDelegate {
    ...
    private val userInfoConvert: UserInfoConvert by lazy {
        UserInfoConvert()
    }

    private val msgContentConvert:MessageContentConvert by lazy {
        MessageContentConvert()
    }
    ...
    val db: ChatDatabase by lazy {
        Room.databaseBuilder(
            ...
            .addTypeConverter(userInfoConvert)
            .addTypeConverter(msgContentConvert)
