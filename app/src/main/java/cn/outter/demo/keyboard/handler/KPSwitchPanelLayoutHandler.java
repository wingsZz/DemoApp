 ...
 */
package cn.outter.demo.keyboard.handler;
...
import cn.outter.demo.keyboard.IPanelConflictLayout;
import cn.outter.demo.keyboard.util.ViewUtil;
 ...
 * Easy and Safe way: {@link cn.outter.demo.keyboard.util.KPSwitchConflictUtil#showPanel(View)}.
 * <p/>
 ...
 * Easy and safe way:
 * {@link cn.outter.demo.keyboard.util.KPSwitchConflictUtil#showKeyboard(View, View)}.
 *
 * @see cn.outter.demo.keyboard.widget.KPSwitchPanelFrameLayout
 * @see cn.outter.demo.keyboard.widget.KPSwitchPanelLinearLayout
 * @see cn.outter.demo.keyboard.widget.KPSwitchPanelRelativeLayout
 */
public class KPSwitchPanelLayoutHandler implements IPanelConflictLayout {
     ...
     * Default is false.
     *
     * @attr ref cn.outter.demo.keyboard.R.styleable#KPSwitchPanelLayout_ignore_recommend_height
     */
     ...
     * @see cn.outter.demo.keyboard.util.KeyboardUtil#getValidPanelHeight
     */
