package cn.outter.demo.widget.picker.controller

import cn.outter.demo.widget.picker.DateTimeConfig
import cn.outter.demo.widget.picker.DateTimeConfig.DAY
import cn.outter.demo.widget.picker.DateTimeConfig.HOUR
import cn.outter.demo.widget.picker.DateTimeConfig.MIN
import cn.outter.demo.widget.picker.DateTimeConfig.MONTH
import cn.outter.demo.widget.picker.DateTimeConfig.SECOND
import cn.outter.demo.widget.picker.DateTimeConfig.YEAR
import cn.outter.demo.widget.picker.DateTimeConfig.formatter
import cn.outter.demo.widget.picker.ext.getMaxDayInMonth
import cn.outter.demo.widget.picker.ext.isSameDay
import cn.outter.demo.widget.picker.ext.isSameHour
import cn.outter.demo.widget.picker.ext.isSameMinute
import cn.outter.demo.widget.picker.ext.isSameMonth
import cn.outter.demo.widget.picker.ext.isSameYear
import cn.outter.demo.widget.picker.number_picker.NumberPicker
...
open class DateTimeController : BaseDateTimeController() {
    ...
    private fun limitMaxAndMin() {
        ...
        var maxDayInMonth =
            getMaxDayInMonth(calendar?.get(Calendar.YEAR), calendar?.get(Calendar.MONTH))
